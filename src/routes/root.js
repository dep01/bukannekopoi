...
import {SplashScreenPage, HomeScreenPage, LoginScreenPage, AnimeListScreen, EpisodeListScreen, WatchScreen, SearchAnimeScreen} from '../pages';
...
const Router = () => {
  return (
    <Stack.Navigator initialRouteName={routes_name.SPLASH}>
      ...
      />
      <Stack.Screen
        name={routes_name.EPISODE_LIST}
        component={EpisodeListScreen}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name={routes_name.WATCH}
